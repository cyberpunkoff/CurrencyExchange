...
## Description
Implementation of CurrencyExchange [project](https://zhukovsd.github.io/java-backend-learning-course/Projects/CurrencyExchange)
from [java-backend-course](https://zhukovsd.github.io/java-backend-learning-course/). **Huge thanks for free materials to [zhukovsd](https://github.com/zhukovsd)! Check it out if you're interested!**  
REST API for currency and exchange rates description. Allows to view and edit lists of currencies and exchange rates, calculate convertions of any money amount from one currency to another.
...
Для всех запросов, в случае ошибки, ответ выглядит так:
```
{
